...
typedef NSMutableArray IMStack;
typedef NSMutableArray IMXueue;

/**
* Implements Stack and Xueue using NSMutableArray
*/
...
/**
* Add the elements of the given array to the Xueue.
